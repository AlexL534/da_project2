...
\begin{DoxyCompactList}\small\item\em Solves the TSP using a hybrid of MST and Nearest Neighbor heuristics. The time complexity of this algorithm is O(\+V\texorpdfstring{$^\wedge$}{\string^}2 log V). \end{DoxyCompactList}\item 
